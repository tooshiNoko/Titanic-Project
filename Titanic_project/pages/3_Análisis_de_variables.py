...
def cargar_imagenes(variable):
    if variable == 'Estudio correlación de variables':
        return [
            Image.open(r'Temario\Modulo1\00_Proyecto_modulo1\Titanic_project\assets\.images\5_matriz_correlacion.png'),
       
        ]
    elif variable == 'Supervivientes según género y edad':
        return [
            Image.open(r'Temario\Modulo1\00_Proyecto_modulo1\Titanic_project\assets\.images\7_supervivientes_genero.png'),
            Image.open(r'Temario\Modulo1\00_Proyecto_modulo1\Titanic_project\assets\.images\8_supervivientes_edad.png'),
            Image.open(r'Temario\Modulo1\00_Proyecto_modulo1\Titanic_project\assets\.images\9_supervivientes_genero_edad.png')
        ]
    elif variable == 'Supervivientes según clase social':
        return [
            Image.open(r'Temario\Modulo1\00_Proyecto_modulo1\Titanic_project\assets\.images\10_supervivientes_genero_clase.png'),
            Image.open(r'Temario\Modulo1\00_Proyecto_modulo1\Titanic_project\assets\.images\12_supervivientes_clase_fare.png')
        ]
    elif variable == 'Supervivientes según puerto de embarcación':
        return Image.open(r'Temario\Modulo1\00_Proyecto_modulo1\Titanic_project\assets\.images\11_supervivientes_embarked.png')
    elif variable == 'Supervivientes según tamaño de familia':
        return Image.open(r'Temario\Modulo1\00_Proyecto_modulo1\Titanic_project\assets\.images\13_supervivientes_familysize.png')
    elif variable == 'Variable Títulos':
        return Image.open(r'Temario\Modulo1\00_Proyecto_modulo1\Titanic_project\assets\.images\14_supervivientes_titulo.png')
